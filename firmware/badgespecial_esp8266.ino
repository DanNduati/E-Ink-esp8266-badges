...
uint8_t broadcastAddresses[13][6] = {
  {0xEC, 0xFA, 0xBC, 0xDD, 0x13, 0xA8},
  {0xEC, 0xFA, 0xBC, 0xDD, 0x9A, 0x99},
  {0xEC, 0xFA, 0xBC, 0xDD, 0x68, 0x25},                
  {0xE8, 0xDB, 0x84, 0xF7, 0x76, 0x54},
  {0xEC, 0xFA, 0xBC, 0xDC, 0xE9, 0x46},
  {0xEC, 0xFA, 0xBC, 0xDD, 0x21, 0x2D},
  {0xEC, 0xFA, 0xBC, 0xDD, 0x8C, 0x61},
  {0xE8, 0xDB, 0x84, 0xF7, 0x7A, 0x6A},
  {0xEC, 0xFA, 0xBC, 0xDD, 0x98, 0xF4}, 
  {0xE8, 0xDB, 0x84, 0xF7, 0x33, 0x78},
  {0xEC, 0xFA, 0xBC, 0xDD, 0x21, 0x2D},
  {0xEC, 0xFA, 0xBC, 0xDD, 0x98,  0xF4},
